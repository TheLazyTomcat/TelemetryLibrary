...
type
  ...
  public
    ...
    procedure OnChannel(Sender: TObject; Name: String; ID: TChannelID; Index: scs_u32_t; Value: p_scs_value_t);
...
procedure TfrmMainForm.OnChannel(Sender: TObject; Name: String; ID: TChannelID; Index: scs_u32_t; Value: p_scs_value_t);
begin
